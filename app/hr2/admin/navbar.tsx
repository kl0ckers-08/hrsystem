...
const navItems = [
  { href: "/hr2/admin/analytics", label: "Analytics", icon: BarChart3 },
  { href: "/hr2/admin/competency", label: "Competency", icon: Users },
  { href: "/hr2/admin/learning", label: "Learning", icon: BookOpen },
  { href: "/hr2/admin/training", label: "Training", icon: GraduationCap },
  { href: "/hr2/admin/admin-ess", label: "ESS", icon: FileText },
  { href: "/hr2/admin/admin-report", label: "Report", icon: FileBarChart },
];
